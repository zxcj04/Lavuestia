package com.fanrende.lavuestia.data;
...
public class CapabilityContainerItemHandler
{
	@CapabilityInject(IItemHandler.class)
	public static Capability<IItemHandler> CONTAINER_ITEM_HANDLER_CAPABILITY = null;
...
//	private static class Storage implements Capability.IStorage<IItemHandler>
//	{
//		@Override
//		public INBT writeNBT(Capability<IItemHandler> capability, IItemHandler instance, Direction side)
//		{
